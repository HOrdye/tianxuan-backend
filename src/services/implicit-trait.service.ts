...
function applySafetyClamp(current: any, news: any): any {
  ...
  return {
    decisiveness: clamp(current.decisiveness, news.decisiveness),
    empathy: clamp(current.empathy, news.empathy),
    drive: clamp(current.drive, news.drive),
    stability: clamp(current.stability, news.stability),
    curiosity: clamp(current.curiosity, news.curiosity),
    sociability: clamp(current.sociability, news.sociability),
  };
}
