...
router.get(
  '/users/:userId/implicit-traits',
  authenticateToken,
  requireAdmin,
  adminController.getUserImplicitTraits
);
...
router.get(
  ...
  authenticateToken,
  requireAdmin,
  adminController.getAdminCoinPacks
);
...
router.post(
  ...
  authenticateToken,
  requireAdmin,
  adminController.createCoinPack
);
...
router.put(
  ...
  authenticateToken,
  requireAdmin,
  adminController.updateCoinPack
);
...
router.delete(
  ...
  authenticateToken,
  requireAdmin,
  adminController.deleteCoinPack
);
